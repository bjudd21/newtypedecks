...
**1-2-3.** If either player fulfills the conditions for defeat, the next time rules management is performed, that player loses the game as a result. (See [11. Rules Management](#11-rules-management))
...
**2-11-3.** Pilot cards typically have two card texts. The card text printed above the card name belongs to the Pilot, and the card text printed below the card name is gained by the Unit paired with it. (See [3-3. Pilots](#3-3-pilots))
...
**3-4-5.** 【Main】 and 【Action】 timing on command effects show when they can be played. (See [12-2. Keywords](#13-2-keywords))
...
**3-4-6-4.** While it is paired as a Pilot, rules for Pilots apply to it. (See [3-3. Pilots](#3-3-pilots))
...
**5-5-2.** A card that receives damage equal to or greater than its HP is destroyed as a result of rules management. (See [11. Rules Management](#11-rules-management))
...
**5-10-3.** When a Shield is destroyed, first reveal it and check for a 【Burst】 effect before placing it into the trash. If a 【Burst】 effect is present, decide if you will activate it before placing the Shield into the trash. (See [12-2-5. 【Burst】](#13-2-5-burst))
...
**7-5-2-1.** The active player may perform the following actions in any order as many times as desired with cards from the hand by paying their cost: deploy a Unit, deploy a Base, pair a Pilot, and activate a Command card with 【Main】 timing. (See [3. Card Types](#3-card-types))
...
**7-5-2-2-4.** Play the card. (See [3. Card Types](#3-card-types))

**7-5-3.** 【Activate･Main】 Activation

**7-5-3-1.** The active player can activate effects with 【Activate･Main】 timing. (See [11-2-1. 【Activate･Main】](#13-2-1-activatemain))

**7-5-4.** Attack with a Unit

**7-5-4-1.** The active player can attack the opposing player or a rested enemy Unit with a Unit in their battle area. (See [7. Attacking and Battles](#8-attacking-and-battles))
...
**7-6-3-1.** Taking turns, starting with the standby player, players can activate 【Action】 Command cards and effects with 【Activate･Action】 timing. (See [9. Action Steps](#9-action-steps))
...
**8-5-2-3-1.** A Shield receiving 1 or more damage is destroyed and placed into the trash after revealing it. If the revealed Shield has a 【Burst】 effect, choose whether or not to activate it before placing the Shield into the trash. (See [12-2-5. 【Burst】](#13-2-5-burst))
...
**8-5-2-4-2.** If the attacking Unit has <First Strike>, it deals battle damage to the enemy Base before normal battle damage is managed. (See [12-1-5. <First Strike>](#13-1-5-first-strike))
...
**8-5-3-2-2.** If the attacking Unit has <First Strike>, it deals battle damage to the enemy Unit before normal battle damage is managed. (See [12-1-5. <First Strike>](#13-1-5-first-strike))
...
**10-1-8-1-1.** If a command effect requires choosing a target, playing that Command card is not possible if that target cannot be chosen.
...
**10-3-3.** When a Command card is played or a triggered effect is triggered and its effect instructs you to "choose 1 (card or player)" or "choose up to (some number of cards)," those targets are chosen at the point in time when the instructions appear in the effect.
...
**12-3-5.** Unlike preparing to play for a two-player battle (see [6. Preparing to Play](#6-preparing-to-play)), each player takes the top four cards of their deck, one at a time while taking turns, and places them face down into the team's shared shield area without looking at them. When doing so, place each card so it overlaps the previous one, starting with the card nearest to you.
