            ...
            <section className="mb-8">
              ...
              <div className="mb-4 rounded-lg bg-gray-50 p-4">
                <p className="text-sm text-gray-700">
                  <strong>What we collect:</strong> Account information (email,
                  username), deck builds, collection data, and basic usage
                  analytics.
                </p>
              </div>
              <ul className="list-inside list-disc space-y-2 text-gray-700">
                ...
                <li>
                  <strong>Game Data:</strong> Your saved decks, collection
                  information, and preferences
                </li>
                <li>
                  <strong>Usage Data:</strong> Basic analytics to improve site
                  functionality (optional)
                </li>
                <li>
                  <strong>Technical Data:</strong> Browser information for
            ...
            <section className="mb-8">
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                ...
                <ul className="list-inside list-disc space-y-1 text-sm text-blue-700">
                  ...
                  <li>
                    <strong>Modify:</strong> Update your account information
                    anytime
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Export:</strong> Download your deck and collection
                    data
                  </li>
                </ul>
              </div>
            ...
            {showContactInfo && (
              <section>
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    This is a community project. For privacy concerns, please
                    check the project&apos;s GitHub repository or contact the
                    maintainers through the official channels.
                  </p>
                </div>
              </section>
            )}
        ...
        <div className="flex-1">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            <p>
              ...
              information needed for account management and site functionality
              (email, username, game data).
            </p>
            <p>
              <strong>Data Usage:</strong> Your information is used solely to
              provide our services and is never shared with third parties or
              used for marketing.
            </p>
            <p>
