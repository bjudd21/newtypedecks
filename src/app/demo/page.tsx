...
export default function DemoPage() {
  return (
    <div className="particle-field relative z-10 min-h-screen p-8">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h1 className="font-display text-gradient mb-4 text-4xl md:text-6xl">
            Component Showcase
          </h1>
          <p className="tech-text text-xl text-cyan-300">
        ...
        <Card variant="cyber" className="mb-8">
          ...
          <CardContent>
            ...
            <div className="mt-6 flex gap-4">
              ...
              <Button variant="plasma" disabled>
                Disabled
              </Button>
            </div>
          </CardContent>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge variant="cyber" animate>
                    Cyber
                  </Badge>
                  <Badge variant="neon" animate>
                    Neon
                  </Badge>
                  <Badge variant="plasma" animate>
                    Plasma
                  </Badge>
                  <Badge variant="hologram" animate>
                    Hologram
                  </Badge>
